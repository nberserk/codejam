...
public class RookAttack2 {
	...
	public int howMany(int rows, int cols, String[] cutouts) {
		...
		Point[] cuts = new Point[cutouts.length];
...
//		// print pair
	...
	boolean find_match_dfs(int source, Point[] cuts) {
		if (mVisited[source]) {
			return false;
		}
		...
		for (int col = 0; col < matchCol.length; col++) {
			...
			for (int j = 0; j < cuts.length; j++) {
				if (source == cuts[j].y && col == cuts[j].x) {
					blocked = true;
					break;
				}
			}
			...
			if (nextRow == -1 || find_match_dfs(nextRow, cuts)) {
				matchRow[source] = col;
				matchCol[col] = source;
				return true;
			}
	...
	boolean find_match(int source, Point[] cuts, int[] matchRow, int[] matchCol) {
...
//		} while (from[where]!=where);
	...
	private boolean bfs(int[] matchRow, int[] matchCol, Point[] cuts, int source) {
...
//		
//	
		flow = r.howMany(15, 25, new String[] {
				"11 23,6 4,10 2,12 15,13 0,1 3,1 17,13 17,8 4,7 13",
				"3 11,12 6,9 19,0 16,7 8,5 21,1 6,12 3,13 9,11 15",
				"9 14,11 0,14 14,14 0,3 2,6 11,4 6,7 18,8 21,4 23",
				"10 15,7 21,4 7,13 0,13 16,0 5,9 14,2 23,1 4,13 17",
				"6 6,2 10,5 20,10 10,2 6,14 12,5 5,5 18,8 17,8 22",
				"9 2,10 16,9 19,3 1,8 5,3 5,4 19,14 15,7 21,9 3",
				"10 17,12 17,2 6,0 19,13 15,9 24,14 17,5 2,2 23",
				"5 9,2 19,14 16,2 5,14 7,1 8,13 12,11 5,6 19,9 12",
				...
				"8 18,9 8,5 7,7 0,0 13,11 15,7 19,11 12,2 15,6 19",
				"7 14,11 14,10 11,1 9,2 20,9 12,1 2,4 1,12 0,9 5",
				"1 18,3 2,14 17,7 10,12 4,1 19,4 13,0 8,13 11,0 4",
				"10 14,1 11,11 21,14 2,4 17,2 2,2 6,7 5,5 22,9 18",
				...
				"8 5,11 0,13 4,13 22,7 6,10 23,1 22,12 9,3 11,5 0",
				"12 13,8 16,3 14,14 21,11 0,14 14,14 16,10 6,13 3",
				"2 4,14 11,14 18,10 15,2 13,12 18,5 7,3 22,2 24",
				"12 7,4 22,11 11,9 21,14 7,0 6,3 3,14 8,11 17,10 8",
				...
				"5 7,9 3,5 4,11 4,2 16,10 6,11 21,14 15,0 17,5 20",
				"6 0,7 11,6 5,0 15,6 15,8 19,4 7,14 13,14 7,0 24",
				"10 4,0 1,8 24,10 2,0 7,7 4,14 12,11 3,13 22,8 12",
				"10 22,4 16,3 4,0 1,3 21,0 5,13 16,11 15,4 14,13 4",
				"7 7,4 17,13 9,1 3,8 7,6 4,8 21,13 11,6 1,11 13",
				"3 20,12 12,2 6,12 15,8 12,1 10,9 22,10 20,10 7",
				"7 24,0 18,14 8,9 10,10 4,7 4,0 8,4 13,14 15,6 11",
				"12 2,8 10,5 10,13 8,13 10,0 1,4 19,6 1,14 9,14 14",
				"12 16,7 11,0 11,5 7,9 19,4 4,8 23,14 11,5 6,4 12",
				"1 20,8 3,3 8,11 24,6 7,8 21,4 14,13 2,12 19,9 24",
				"4 13,14 16,1 11,4 1,6 22,6 0,10 14,5 19,12 13,6 11",
				"14 4,13 21,13 24,9 20,1 14,12 18,3 8,6 24,14 16",
				"6 3,0 4,2 8,3 6,5 1,11 12,4 8,14 22,10 7,2 6,13 7",
				"3 1,6 21,6 23,10 15,0 20,13 10,9 2,14 4,9 4,1 15",
				"14 21,5 14,4 15,8 15,2 22,5 13,4 23,13 6,14 13",
				"1 12,14 3,4 18,1 17,6 8,4 20,14 11,4 4,5 23,10 0",
				"9 18,8 13,5 21,9 20,14 4,8 10,9 8,11 11,9 23,3 7",
				"11 16,12 15,10 2,3 11,13 22,7 3,11 1,10 3,9 8",
				"8 15,13 15,1 17,7 16,4 20,14 17,0 10,1 11,7 18",
				"1 3,5 7,3 20,12 23,12 12,5 24,3 15,3 23,10 24,2 9",
				"1 10,2 22,0 6,7 19,14 16,9 12,4 23,7 10,9 13,0 24",
				"11 0,5 5,0 9,5 15,5 11,8 14,13 6,12 17,2 21,7 2",
